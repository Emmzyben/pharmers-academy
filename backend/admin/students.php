...
$query = "SELECT id, firstName, lastName, enrolment_number, course FROM students";
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">All student</h3>
                  <h6 class="font-weight-normal mb-0">All currently enrolled students</h6>
                </div>
    ...
    <tbody>
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        <td>{$studentName}</td>
                        <td class='font-weight-bold'>{$enrolmentNumber}</td>
                        <td>{$course}</td>
